...
# how to count number of occurenece of any digit in tupple ?

tuple = (2,2,4,5,6,6,6,6,6,999,1000000)

gino = tuple.count(6)
print(gino)

# list mai bhi yahi same chlega count krne k tareeka ...

# how to detect index in list?

listtttt= [ 2,4,88,333,55,77,88,99999,0]
ginoo = listtttt.index(0)
print(ginoo)
